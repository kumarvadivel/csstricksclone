...
export class HeroArticleComponent {
  ...
  constructor() { }
    ...
    meta:"Fresh Article",
    date:"June 8, 2020",
    title:"The Trickery it Takes to Create eBook-Like Text Columns",
    author_name:"Chris Coyier",
    author_img:"https://secure.gravatar.com/avatar/8081b26e05bb4354f7d65ffc34cbbd67?s=80&d=retro&r=pg",
    content:"There’s some interesting CSS trickery in Jason Pamental’s digital book experience  on mobile. Which brings up an interesting question right away… how do you set full-width columns that add columns horizontally, as-needed ?  Well that’s a good trick right there, and it’s a one-liner:"
